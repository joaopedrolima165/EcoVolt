...
:root {
  ...
  --sidebar: 222 28% 5%;
  --sidebar-foreground: 220 15% 93%;
  --sidebar-border: 222 18% 13%;
  --sidebar-primary: 25 95% 55%;
  --sidebar-primary-foreground: 222 28% 5%;
  --sidebar-accent: 222 18% 13%;
  --sidebar-accent-foreground: 220 15% 93%;
...
@keyframes glow-pulse {
  0%, 100% { filter: drop-shadow(0 0 6px hsl(25 95% 55% / 0.5)); }
  50% { filter: drop-shadow(0 0 18px hsl(25 95% 55% / 0.9)) drop-shadow(0 0 32px hsl(25 95% 55% / 0.4)); }
}
